...
This example uses `wa_page()`, `wa_container()`, and a handful of generated
...
These examples are strong candidates for `shinylive` on the documentation
website because readers benefit from being able to interact with the components
and see the resulting Shiny state directly.

If this page later becomes too large, it can be split into separate examples or
showcase articles. Starting with one article keeps the first documentation pass
