...
Web Awesome's theme system is page-oriented. Apply theme,
palette, and brand classes to the `<html>` element, for example:
...
`webawesomePage()` is the best place for this because it owns the full page
scaffold, including the root `<html>` tag.
